...
module.exports = {
     ...
     */
    brightnessContrastPhotoshop: async function (srcImageData, brightness, contrast) {
     ...
     */
    dither: async function (srcImageData, levels)  {
